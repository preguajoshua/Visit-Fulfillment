...
class FollowUp extends Model
{
    ...
    */
     ...
     * @var string
     */
    protected $table = 'axxesscarevisitfulfillment_followup';
    ...
    /**
     * Get the professional that owns the follow-up.
     */
    ...
    {
        return $this->belongsTo(Facilities::class, 'Id', 'EntityId');
    }
    ...
    /**
     * Scope a query to only include active follow-ups.
     *
    ...
    /**
     * Depricate the follow-up instance.
     *
     * @return  void
     */
