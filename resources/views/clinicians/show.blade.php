<x-app-layout>
    ...
    <div class="space-y-6">
            ...
            <div class="flex flex-wrap justify-between px-4 py-5 sm:px-6">
                ...
                <div class="flex flex-col flex-wrap space-y-2">
                    ...
                    <div class="flex flex-row justify-end space-x-1 text-gray-500">
                        ...
                        <p class="text-sm">
                            {{ $clinician->identity->PhoneNumber }}
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 space-y-10">
                            <div class="sm:grid sm:grid-cols-2">
                                <div class="flex flex-col">
                                    <p class="text-gray-500 font-medium ">Jobs Applied</p>
                                    <p> {{ $jobsApplied }} </p>
                                </div>
                                <div class="flex flex-col">
                            ...
                            <div class="sm:grid sm:grid-cols-2">
                                <div class="flex flex-col">
                                    <p class="text-gray-500 font-medium ">Profile Started</p>
                                    <p>
                                        {{ $clinician->Created }}
                                    </p>
                                </div>
        ...
        {{-- Clinician Notes --}}
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <livewire:manage-clinician-notes :clinician="$clinician">
        </div>

        {{-- Schedule Follow-up / Clinician Logs --}}
        <div x-data="{ isActive: 1 }" class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="flex justify-center mt-5">
                <ul id="tabs" class="flex justify-center w-full px-1 pt-2">
                    ...
                    <li x-on:click="isActive = 2" x-bind:class="isActive == 2 ? 'border-b-2 border-green-400 opacity-100' : 'hover:opacity-80'" class="px-4 py-2 font-semibold text-gray-800 rounded-t cursor-pointer opacity-50 ">Clinician Logs</li>
                </ul>
            </div>
            <div x-show="isActive == 1" class="mt-5 bg-white shadow overflow-hidden sm:rounded-lg">
                <livewire:manage-follow-ups  :clinician="$clinician">
            </div>
            <div x-show="isActive == 2" class="mt-5 bg-white shadow overflow-hidden sm:rounded-lg">
                <livewire:manage-clinician-logs  :clinician="$clinician">
            </div>
        </div>
